...
class CandidateInfo(BaseModel):
    ...
    gpa_snippets: Optional[list[str]] = None
    education: Optional[list[str]] = None
    education_snippets: Optional[list[str]] = None
...
Laura has a bachelors degree in Economics and Business Administration from CBS and amasters degree in Business Intelligence from AU.  
...
async def send_input():
    try:
        ...
        gpa_snips = npa.gpa_snippets or []
        edu_snips = npa.education_snippets or []
        persona_snips = npa.persona_snippets or []

        snippets = gpa_snips + edu_snips + persona_snips

        output_area.value = (
            f"gpa={npa.gpa}\n"
            f"education={npa.education}\n"
