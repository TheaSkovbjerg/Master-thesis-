...
ui.label('Upload Grade Transcript').classes('text-white text-bold').style('font-size: 18px;')
ui.upload(on_upload=upload_transcript, auto_upload=True).props('accept=.pdf color=#a301ff')

ui.label('Transcript Grading System').classes('text-white text-bold').style('font-size: 18px;')
transcript_grading_system = ui.select(
    GRADING_SYSTEMS,
    value="Danish 7-point",
).props('color=#a301ff').classes('w-64 text-white')

conversion_area = ui.markdown('').classes('w-full text-white')
...
<div style="
    ...
    font-size: 14px;
">
    <div style="font-weight: 700; font-size: 15px; margin-bottom: 10px;">Highlight glossary</div>
    <div style="display: flex; gap: 8px; align-items: center; margin-bottom: 8px;">
        <span style="display: inline-block; width: 18px; height: 12px; background: rgb(255, 255, 0);"></span>
        <span>Candidate facts</span>
    </div>
    <div style="display: flex; gap: 8px; align-items: center;">
        <span style="display: inline-block; width: 18px; height: 12px; background: rgb(135, 207, 255);"></span>
