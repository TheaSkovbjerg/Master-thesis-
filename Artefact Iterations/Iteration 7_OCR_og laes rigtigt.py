...
async def extract_text_from_pdf(e):
...
ui.upload(on_upload=extract_text_from_pdf, auto_upload=True, multiple=True).props('accept=.pdf')
...
def save_to_excel():
    ...
    path = '/Users/theafrost/Artefakt/TEST.xlsx'
